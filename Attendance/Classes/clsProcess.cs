            ...
            try
            {
                    ...
                    foreach (DataRowView drShift in dvShift)
                    {
                        ...
                        if (tInTime >= ShiftInFrom && tInTime <= ShiftInTo)
                        {
                            ...
                            if (drAttd["ConsOut"] is DateTime)
                            {
                                ...
                                //            drAttd["Halfday"] = 0;
                                //        }
                                //        else if (drAttd["LeaveTyp"].ToString() != "" && drAttd["Status"].ToString() == "P")
                                //        {
                                //            drAttd["Halfday"] = 0;
                                //        }
                                //        else if (drAttd["LeaveTyp"].ToString() == "" && drAttd["Status"].ToString() == "P")
                ...
                else
                {
                    ...
                    else //if emp comes before schedule shift set early times
                    {
                        ...
                        else if (secearly > (-1 * Globals.G_EarlyComeSec) && eWrkGrp == "COMP" && eGradeCode > 15 && drAttd["LeaveTyp"].ToString() != "")
                        {
                            drAttd["Halfday"] = 0;
                            drAttd["Latecome"] = "";
                            drAttd["EarlyCome"] = "";
