...
{
    public partial class frmMastEmpCreateMuster : Form
    {
        ...
        public frmMastEmpCreateMuster()
        {
            InitializeComponent();
        }

        private void frmMastEmpCreateMuster_Load(object sender, EventArgs e)
        {
            ResetCtrl();
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtEmpUnqID.Text.Trim()))
            {
                 ...
                 sql = "Select CompCode,EmpUnqID,WeekOff From v_EmpMast Where CompCode ='" + txtCompCode.Text.Trim() + "' and  WrkGrp = '" + txtWrkGrpCode.Text.Trim() + "' And Active = '1' Order By EmpUnqID";
                ...
                sql = "Select CompCode,EmpUnqID,WeekOff From v_EmpMast Where CompCode ='" + txtCompCode.Text.Trim() + "' "
            ...
            if (hasRows)
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    clsEmp t = new clsEmp();
                    if (t.GetEmpDetails( EmpUnqID))
                    {
                       string err1 = string.Empty;
                        bool t1 = t.CreateMuster(EmpUnqID, fromdt, todt, out err1);
                       if (!t1)
                       {
