...
{
    public partial class frmMain1 : XtraForm
    {
        ...
        private void mnuMisConduct_Click(object sender, EventArgs e)
        {
            ...
            if (t == null)
            {
                Attendance.Forms.frmMastEmpMisConduct m = new Attendance.Forms.frmMastEmpMisConduct();
                m.MdiParent = this;
                m.Show();
            }
        }
        ...
        private void mnuRulesCheck_Click(object sender, EventArgs e)
        {
            ...
            if (t == null)
            {
                Attendance.Forms.frmTranLeaveRulesCheck m = new Attendance.Forms.frmTranLeaveRulesCheck();
        ...
        private void mnuBlackListAdhar_Click(object sender, EventArgs e)
        {
            ...
            if (t == null)
            {
                Attendance.Forms.frmTranEmpBlackList m = new Attendance.Forms.frmTranEmpBlackList();
                m.MdiParent = this;
                m.Show();
            }
        }
